...
if __name__ == '__main__':
    ...
    sthv2_categories_file = "/ssd4/zhangyiyang/data/something-something-v2/category.txt"
    with open(sthv2_categories_file, "r") as f:
        sthv2_categories = f.readlines()
    sthv2_categories = [s.strip() for s in sthv2_categories]
    sthv2_target_ids = [46]
    sthv2_loader_file = "/ssd4/zhangyiyang/data/something-something-v2/train_videofolder.txt"
    sthv2_target_frames_folder = "/ssd4/zhangyiyang/data/something-something-v2/20bn-something-something-v2-frames"
    _do_filter(
        sthv2_loader_file,
        sthv2_target_ids,
        sthv2_target_frames_folder,
    )
